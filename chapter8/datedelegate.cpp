...
void DateDelegate::setModelData(QWidget *eidtor, QAbstractItemModel *model, const QModelIndex &index) const
{
    QDateTimeEdit *edit = static_cast<QDateTimeEdit*>(eidtor);
